...
namespace Friendships.Write.Infrastructure.IntegrationEvents.BackgroundService;
...
public class ConsumeIntegrationEventsBackgroundService : IHostedService
{
    ...
    private async void PublishIntegrationEvent(object? sender, BasicDeliverEventArgs eventArgs)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Integration event published in Friends Integration Events successfully. Sending ack to message broker.");
